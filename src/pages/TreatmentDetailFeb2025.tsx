...
const TreatmentDetailFeb2025 = () => {
  ...
  const handleTabChange = (value: string) => {
    setActiveTab(value);
    navigate(`/treatment-detail-feb-2025?tab=${value}`);
  };
      ...
      <div className="space-y-8">
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          <TabsList className="mb-6 bg-muted/20 p-1 rounded-md">
            <TabsTrigger value="tratamento" onClick={() => navigate('/financial-treatment')}>
              Diagnóstico Geral
            </TabsTrigger>
            <TabsTrigger value="tratamento-detalhado" onClick={() => navigate('/financial-health/detailed')}>
