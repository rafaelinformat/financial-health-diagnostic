  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 p-4 max-w-7xl mx-auto">
        {/* Header Card */}
        <div className="glass-card p-6 rounded-lg shadow-sm grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div>
            <h2 className="text-lg font-semibold mb-2">Exame de Risco de Falência</h2>
            <div className="text-sm">
              <p><span className="font-semibold">Empresa:</span> TECNO MONTAGENS SOLUÇÕES DE ENGENHARIA</p>
              <p><span className="font-semibold">Data de Criação da Empresa:</span> 01/2023</p>
              <p><span className="font-semibold">Setor:</span> Industrial – Montagens e Engenharia</p>
            </div>
          </div>
          <div>
            <div className="text-sm space-y-2">
              <p><span className="font-semibold">Data de análise dos dados:</span> 2025</p>
              <p><span className="font-semibold">Idade da empresa:</span> 2 anos</p>
              <p><span className="font-semibold">Período de análise:</span> 01/01/2025 a 31/01/2025</p>
              <p><span className="font-semibold">Solicitado por:</span> Vitória</p>
            </div>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <span className="bg-green-600 text-white text-xs font-semibold uppercase px-3 py-1 rounded-full">
              Saudável
            </span>
        ...
        {/* Conclusão */}
        <div className="glass-card p-6 rounded-lg shadow-sm text-sm max-w-4xl">
