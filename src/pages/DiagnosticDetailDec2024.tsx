...
const DiagnosticDetailDec2024 = () => {
  ...
  // Dados da Empresa e indicadores dados conforme solicitado
  const diagnosticData = {
    company: {
      name: 'TECNO CHAPA SOLUCOES EM CORTE E DOBRA LTDA',
      creationDate: '01/2023',
      age: '2 anos',
      sector: 'Indústria/Serviços (Corte e Dobras Metálica)',
  ...
  // Funções para renderizar tabelas para cada categoria seguindo layout da imagem
      ...
      <div className="space-y-8">
        ...
        <Tabs defaultValue="diagnostico" className="w-full">
          <TabsList className="mb-6 bg-muted/20 p-1 rounded-md">
            ...
            <TabsTrigger value="diagnostico" onClick={() => navigate('/financial-health/detailed')}>
